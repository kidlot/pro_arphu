...
<div id="main_content">
    ...
    <div class="content_row row sub_page_header fullwidth " style="background-image: url(http://www.wencomining.com/wp-content/uploads/2017/01/bridge.jpg);background-size: auto auto;background-position: right top;">

        <div class="content_row_wrapper  default" ><div class="col col-sm-12"><section class="page-title"><h1>Our Company</h1></section></div></div>
    </div>
    ...
    <div  class="content_row row vc_row wpb_row vc_row-fluid default-style fullwidth border_grid fixed_heights animate-cols" >
        ...
        <div class="content_row_wrapper  fullwidth" ><div class="vc_col-sm-6 wpb_column vc_column_container">
                        ...
                        <div class="wpb_wrapper">
                            ...
                            <div class="wpb_single_image wpb_content_element vc_align_left">
                                ...
                                <figure class="wpb_wrapper vc_figure">
                                    <div class="vc_single_image-wrapper   vc_box_border_grey"><img width="150" height="150" src="/Public/Default/home/upload/150150-1.jpg" class="vc_single_image-img attachment-thumbnail" alt="" /></div>
                                </figure>
                            </div>
                            ...
                            <div class="wpb_wrapper">
                                ...
                                <div class="wpb_text_column wpb_content_element ">
                                    <div class="wpb_wrapper">
                                        ...
                                        <p>Arphu aims to provide excellent service to its clients with 24 x 7 support from the team. We provide the right products to meet the clients requirements, prolong belt life, short belt downtime and accidents.<span class="aap">  </span></p>
                    ...
                    <div class="content_row_wrapper  " ><div class="vc_col-sm-3 wpb_column vc_column_container">
                        <div class="wpb_wrapper">
                            ...
                            <div class="wpb_single_image wpb_content_element vc_align_left">
                                ...
                                <figure class="wpb_wrapper vc_figure">
                                    <div class="vc_single_image-wrapper   vc_box_border_grey"><img width="150" height="150" src="/Public/Default/home/upload/150150-2.jpg" class="vc_single_image-img attachment-thumbnail" alt="" /></div>
                                </figure>
                            </div>
                        ...
                        <div class="vc_col-sm-9 wpb_column vc_column_container">
                            <div class="wpb_wrapper">
                                ...
                                <div class="wpb_text_column wpb_content_element ">
                                    <div class="wpb_wrapper">
                                        <h5><strong>Professional Manufacturer</strong></h5>
                                        <p>Arphu will always continue to focus on the design, produce, sales, engineering technical consultation and project contracting of conveyor belt vulcanizing press (conveyor belt vulcanizer, hot splicing machine), belt repair vulcanizer, because we believe that the conveyor belt makes a real impact on the conveyor running and productivity. we will also focus on the quality management, creating an excellent technical service team, upgrading the service quality and realizing win-win integrity with customers. We proudly provide conveyor belt maintenance service, tools and equipment to power plant, steel plant, cement plant, mine, port, chemical industry, etc.  </p>
                    ...
                    <div class="content_row_wrapper  " ><div class="vc_col-sm-3 wpb_column vc_column_container">
                        <div class="wpb_wrapper">
                            ...
                            <div class="wpb_single_image wpb_content_element vc_align_left">
                                ...
                                <figure class="wpb_wrapper vc_figure">
                                    <div class="vc_single_image-wrapper   vc_box_border_grey"><img width="150" height="150" src="/Public/Default/home/upload/150150-3.jpg" class="vc_single_image-img attachment-thumbnail" alt="" /></div>
                                </figure>
                            </div>
                                ...
                                <div class="wpb_text_column wpb_content_element ">
                                    <div class="wpb_wrapper">
                                        <header class="vc_cta3-content-header">
                                            <h5><strong>Products<br />
                                            </strong></h5>
                                            <ul>
                                                <li>Conveyor belt vulcanizing presses (conveyor belt vulcanizers)</li>
                                                <li>Belt repair vulcanizers</li>
                                                <li>Conveyor belt strip machines (belt peelers)</li>
                                                <li>Pull cord switches</li>
                                                <li>Belt sway switches (belt misalignment switches) </li>
                                                <li>Speed detector</li>
                                                <li>PVC/PU belt joint presses</li>
                                            </ul>
                                        </header>
            ...
            <div class="vc_col-sm-6 wpb_column vc_column_container">
                <div class="wpb_wrapper">
                    <article   class="image-content-box content-box box-style-1 left"><div class="featured_image_holder"><img class="img-responsive" src="/Public/Default/home/upload/634476.jpg" alt="" /></div><div class="text-holder"><h4 class="heading">About us</h4> <ul>
                        <li>Suzhou Arphu Industrial Co., Limited, which devotes itself to the field of R & D, manufacture and sale of Conveyor Belt Vulcanizer (also called Conveyor Belt Vulcanizing Press), We are specializing, focusing and concentrating on conveyor belt maintenance, service and overall scheme design and construction. </li>
                        <li>People-oriented, quality-controlled, excellent management, expanding markets and superior service are our concept of development. Holding the concept, we provide comprehensive service for industrial and mining, power plant, steel mill, port,  chemical industry and cement enterprises, etc. </li>
                        <li>Customer-oriented and supported by engineering materials and engineering technology. Paying attention to management, creating an excellent technical service team, comprehensively upgrading the service quality and realizing win-win integrity with customers. </li>
                    </ul>
                    </div></article>
                </div>
            </div>
    ...
    <div  class="content_row row vc_row wpb_row vc_row-fluid default-style fullwidth border_grid fixed_heights" style="background-color: #7eb901;">
        ...
        <div class="content_row_wrapper  fullwidth" style="padding-top:50px;padding-bottom:50px;">
            <div class="vc_col-sm-6 wpb_column vc_column_container">
                <div class="wpb_wrapper">
                    ...
                    <div class="rt_heading_wrapper style-2">
                        <h4 class="rt_heading  style-2" ><span class="icon-glyph-15 heading_icon"></span>Enterprise Culture</h4>
                    </div>
                    <div class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_left-to-right">
                        <div class="wpb_wrapper">
                            <p><span style="color: #ffffff;">We Exist to Pursue Greatness and perfection.</span></p>
                    ...
                    <div class="rt_heading_wrapper style-2">
                        <h4 class="rt_heading  style-2" ><span class="icon-glyph-15 heading_icon"></span>Our quality policy</h4>
                    </div>
                    <div class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_left-to-right">
                        <div class="wpb_wrapper">
                            <p><span style="color: #ffffff;">Honest, excellent service and pursuit of excellence.</span></p>

                        </div>
                    </div>

                    <div class="rt_heading_wrapper style-2">
                        <h4 class="rt_heading  style-2" ><span class="icon-glyph-15 heading_icon"></span>Corporate Mission</h4>
                    </div>
                    <div class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_left-to-right">
                        <div class="wpb_wrapper">
                            <p><span style="color: #ffffff;">Creating wealth for the society, creating value for our clients and creating happiness for our staff.</span></p>
            ...
            <div class="vc_col-sm-6 wpb_column vc_column_container">
                <div class="wpb_wrapper">
                    ...
                    <div class="rt_heading_wrapper style-2">
                        <h4 class="rt_heading  style-2" ><span class="icon-glyph-15 heading_icon"></span>Our Core Values</h4>
                    </div>
                    <div class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_left-to-right">
                        <div class="wpb_wrapper">
                            <p><span style="color: #ffffff;"> Innovation, initiative and all-win harmony.</span></p>
                    ...
                    <div class="rt_heading_wrapper style-2">
                        <h4 class="rt_heading  style-2" ><span class="icon-glyph-15 heading_icon"></span>Corporate Spirit</h4>
                    </div>
                    <div class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_left-to-right">
                        <div class="wpb_wrapper">
                            <p><span style="color: #ffffff;">Solidarity, diligence and firmness.</span></p>

                        </div>
                    </div>

                    <div class="rt_heading_wrapper style-2">
                        <h4 class="rt_heading  style-2" ><span class="icon-glyph-15 heading_icon"></span>Management Concept</h4>
                    </div>
                    <div class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_left-to-right">
                        <div class="wpb_wrapper">
                            <p><span style="color: #ffffff;">Scientific, standardized, efficient and pragmatic.</span></p>
    ...
    <div  class="content_row row vc_row wpb_row vc_row-fluid default-style fullwidth" >
        ...
        <div class="content_row_wrapper  default" >
            <div class="vc_col-sm-12 wpb_column vc_column_container">
                <div class="wpb_wrapper">
                    <div class="rt_heading_wrapper style-2">
                        <h1 class="rt_heading  style-2" >Our Company History</h1>
                    </div>
		...
		<span class="event-date">
			...
			<span class="year">2007</span>
                            ...
                            <div class="event-details"><h4 class="event-title">(Jiangsu Chenggong | Mining Industry)</h4><div class="list-content">
                                <p>Launch of JSCG (Arphu Industrial | Mining)</p>
                            </div>
                            </div>
                        </div>
		...
		<span class="event-date">
			...
			<span class="year">2008</span>
                            ...
                            <div class="event-details"><h4 class="event-title">Export to Mexico BVIOS</h4><div class="list-content">
                                <p>Conveyor Belt Vulcanizer (1st order)</p>
                            </div>
                            </div>
                        </div>
		...
		<span class="event-date">
			...
			<span class="year">2009</span>
                            ...
                            <div class="event-details"><h4 class="event-title">Developed customers more than 20 Countries , including Lafarge Group</h4><div class="list-content">
                                <p></p>
                            </div>
                            </div>
                        </div>
		...
		<span class="event-date">
			...
			<span class="year">2009</span>
                            ...
                            <div class="event-details"><h4 class="event-title">(DL Industrial Limited| Mining )</h4><p>Launch of DL (Arphu Industrial | Mining)</p>
                            </div>
                        </div>
		...
		<span class="event-date">
			...
			<span class="year">2010</span>
                            ...
                            <div class="event-details"><h4 class="event-title">Cooperate with World’s Largest Copper Ming (Escondida mine-BHP Billiton Ltd)</h4><p></p>
                            </div>
                        </div>
                        <div  >
		...
		<span class="event-date">
			...
			<span class="year">2016</span>
                            ...
                            <div class="event-details"><h4 class="event-title">New Stage | Developed customers </h4><p>more than 60 countries & regions</p>
                            </div>
                        </div>
                        <div  >
		...
		<span class="event-date">
			...
			<span class="year">2017</span>
                            ...
                            <div class="event-details"><h4 class="event-title">(Suzhou Arphu | Mining Industry)</h4><p>Launch of Suzhou Arphu Industrial</p>
                            </div>
                        </div>
                        <div  >
		...
		<span class="event-date">
			...
			<span class="year">2017</span>
                            ...
                            <div class="event-details"><h4 class="event-title">New Journey & Further Expansion</h4><p>Arphu Industrial expands internationally to all over the world</p>
                            </div>
                        </div>
                    </section>
        ...
        <div class="content_row_wrapper  fullwidth" ><div class="vc_col-sm-6 wpb_column vc_column_container">
            <div class="wpb_wrapper">
                <div class="rt_heading_wrapper style-1">
                    <h1 class="rt_heading  style-1" >Diverse Team </h1>
                </div>
                <div class="wpb_text_column wpb_content_element ">
                    <div class="wpb_wrapper">
                        <h4><strong>We have a team with rich experience and enthusiasm, and we are committed to work together for the same goal, to better our products and service for our clients in various fields.</strong></h4>
    ...
    <div  class="content_row row vc_row wpb_row vc_row-fluid default-style fullwidth" >
        ...
        <div class="content_row_wrapper  default" >
            <div class="vc_col-sm-12 wpb_column vc_column_container">
                <div class="wpb_wrapper">
                    <section id="staff-929468" class="team border_grid clearfix  "><div class="row clearfix"><div class="col col-sm-4">


                        <div class="loop post-3172 staff type-staff status-publish has-post-thumbnail hentry" id="person-3172">
                            <div class="person_image">
                                <div class="person_image_wrapper">

                                    <img src="/Public/Default/home/upload/leader1.jpg" alt="" class="" />
                                </div>

                            </div>

                            <h5 class="person_name">Nolberto  Maldonado</h5>

                            <span class="position">Global Technical Manager</span>

                            <div class="profile">
                                I joined Arphu in 2015 after being the agent of Arphu, we started our first cooperation from 2008 when I work in SRB in the rubber industry my entire career. Being a trainer, I have trained over 3,000 people in rubber lining, belt splicing and re-treading.	</div>

                            <div class="person_links_wrapper"><ul class="social_media"><li class="mail"><a class="icon-mail" target="_self" href="mailto:Rudi@wenco.com.au" title="Email"><span>Email</span></a></li><li class="linkedin"><a class="icon-linkedin" target="_blank" href="https://au.linkedin.com/in/rudolf-michel-29491510b" title="Linkedin"><span>Linkedin</span></a></li></ul></div>
                        </div></div>
                            ...
                            <div class="loop post-3170 staff type-staff status-publish has-post-thumbnail hentry" id="person-3170">
                                <div class="person_image">
                                    <div class="person_image_wrapper">
                                        ...
                                        <img src="/Public/Default/home/upload/leader2.jpg" alt="Rohit Katti Wenco" class="" />
                                    </div>

                                </div>

                                <h5 class="person_name">Jianguo Cai</h5>

                                <span class="position">Belt Splicing Specialist & Electrical Engineer</span>

                                <div class="profile">
                                    As a belt splicing specialist, I served over 500 customers as specialist in the field rubber and steel cord belt, as a specialist, I visited many countries to guide and train for our customers. Also being an electrical engineer, I also repair or change heating resistors and electrical control cabinet, etc.	</div>

                                <div class="person_links_wrapper"><ul class="social_media"><li class="mail"><a class="icon-mail" target="_self" href="mailto:Rohit@wenco.com.au" title="Email"><span>Email</span></a></li><li class="linkedin"><a class="icon-linkedin" target="_blank" href="https://www.linkedin.com/in/rohit-katti-5ba8134b" title="Linkedin"><span>Linkedin</span></a></li></ul></div>
                            </div></div>
                        <div class="col col-sm-4">
                            ...
                            <div class="loop post-3176 staff type-staff status-publish has-post-thumbnail hentry" id="person-3176">
                                <div class="person_image">
                                    <div class="person_image_wrapper">
                                        ...
                                        <img src="/Public/Default/home/upload/leader4.jpg" alt="" class="" />
                                    </div>

                                </div>

                                <h5 class="person_name">Meng Zhou</h5>

                                <span class="position">Belt Splicing Specialist & Electrical Engineer</span>

                                <div class="profile">
                                    It’s my honor to join the team of Arphu as a belt splicing specialist & electrical engineer, work with the vibrant and flourishing team, serve for our customers bring me happiness and task commitment.
                                </div>

                                <div class="person_links_wrapper"><ul class="social_media"><li class="mail"><a class="icon-mail" target="_self" href="" title="Email"><span>Email</span></a></li><li class="linkedin"><a class="icon-linkedin" target="_blank" href="" title="Linkedin"><span>Linkedin</span></a></li></ul></div>
                            </div></div>
                    </div><div class="row clearfix"><div class="col col-sm-4">


                        <div class="loop post-3180 staff type-staff status-publish has-post-thumbnail hentry" id="person-3180">
                            <div class="person_image">
                                <div class="person_image_wrapper">

                                    <img src="/Public/Default/home/upload/leader3.jpg" alt="" class="" />
                                </div>

                            </div>

                            <h5 class="person_name">Xihong Lu</h5>

                            <span class="position">Mechanical Engineer</span>

                            <div class="profile">
                                Working with Arphu brings me young mind and entrepreneurial spirit.
                            </div>
            ...
            <div class="vc_col-sm-12 wpb_column vc_column_container">
                <div class="wpb_wrapper">
                    <div class="rt_heading_wrapper style-7">
                        <h1 class="rt_heading  aligncenter style-7" >Our Trusted Partners</h1>
                            ...
                            <div class="vc_col-sm-2 wpb_column vc_column_container">
                                <div class="wpb_wrapper">
                                    ...
                                    <div class="wpb_single_image wpb_content_element vc_align_left">
                                        ...
                                        <figure class="wpb_wrapper vc_figure">
                                            <a href="" target="_blank" class="vc_single_image-wrapper   vc_box_border_grey"><img width="100" height="95" src="/Public/Default/home/upload/1.png" class="vc_single_image-img attachment-thumbnail" alt="" /></a>
                                        </figure>
                                    </div>
                            ...
                            <div class="vc_col-sm-2 wpb_column vc_column_container">
                                <div class="wpb_wrapper">
                                    ...
                                    <div class="wpb_single_image wpb_content_element vc_align_center">
                                        ...
                                        <figure class="wpb_wrapper vc_figure">
                                            <a href="" target="_blank" class="vc_single_image-wrapper   vc_box_border_grey"><img width="150" height="150" src="/Public/Default/home/upload/2.jpg" class="vc_single_image-img attachment-thumbnail" alt="" srcset="/Public/Default/home/upload/2.jpg 150w, /Public/Default/home/upload/2.png 200w" sizes="(max-width: 150px) 100vw, 150px" /></a>
                                        </figure>
                                    </div>
                            ...
                            <div class="vc_col-sm-2 wpb_column vc_column_container">
                                <div class="wpb_wrapper">
                                    ...
                                    <div class="wpb_single_image wpb_content_element vc_align_left">
                                        ...
                                        <figure class="wpb_wrapper vc_figure">
                                            <a href="" target="_blank" class="vc_single_image-wrapper   vc_box_border_grey"><img width="100" height="95" src="/Public/Default/home/upload/4.jpg" class="vc_single_image-img attachment-thumbnail" alt="" /></a>
                                        </figure>
                                    </div>
                            ...
                            <div class="vc_col-sm-2 wpb_column vc_column_container">
                                <div class="wpb_wrapper">
                                    ...
                                    <div class="wpb_single_image wpb_content_element vc_align_left">
                                        ...
                                        <figure class="wpb_wrapper vc_figure">
                                            <a href="" target="_blank" class="vc_single_image-wrapper   vc_box_border_grey"><img width="150" height="95" src="/Public/Default/home/upload/5.png" class="vc_single_image-img attachment-thumbnail" alt="" /></a>
                                        </figure>
                                    </div>
                            ...
                            <div class="vc_col-sm-2 wpb_column vc_column_container">
                                <div class="wpb_wrapper">
                                    ...
                                    <div class="wpb_single_image wpb_content_element vc_align_left">
                                        ...
                                        <figure class="wpb_wrapper vc_figure">
                                            <a href="" target="_blank" class="vc_single_image-wrapper   vc_box_border_grey"><img width="150" height="95" src="/Public/Default/home/upload/6.jpg" class="vc_single_image-img attachment-thumbnail" alt="" /></a>
                                        </figure>
                                    </div>
                            ...
                            <div class="vc_col-sm-2 wpb_column vc_column_container">
                                <div class="wpb_wrapper">
                                    ...
                                    <div class="wpb_single_image wpb_content_element vc_align_left">
                                        ...
                                        <figure class="wpb_wrapper vc_figure">
                                            <a href="" target="_blank" class="vc_single_image-wrapper   vc_box_border_grey"><img width="150" height="95" src="/Public/Default/home/upload/7.jpg" class="vc_single_image-img attachment-thumbnail" alt="" /></a>
                                        </figure>
                                    </div>
                            ...
                            <div class="vc_col-sm-2 wpb_column vc_column_container">
                                <div class="wpb_wrapper">
                                    ...
                                    <div class="wpb_single_image wpb_content_element vc_align_left">
                                        ...
                                        <figure class="wpb_wrapper vc_figure">
                                            <a href="" target="_blank" class="vc_single_image-wrapper   vc_box_border_grey"><img width="150" height="95" src="/Public/Default/home/upload/bhp.jpg" class="vc_single_image-img attachment-thumbnail" alt="" /></a>
                                        </figure>
                                    </div>
