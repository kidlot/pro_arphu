...
<div id="main_content">
    ...
    <div class="content_row row sub_page_header fullwidth " style="background-image: url(http://www.wencomining.com/wp-content/uploads/2015/02/bridge.jpg);background-repeat: repeat;background-size: auto auto;background-attachment: scroll;background-color: rgba(255, 255, 255, 0.3);">
        ...
        <div class="content_row_wrapper  default" ><div class="col col-sm-12"><div class="breadcrumb"><ol vocab="http://schema.org/" typeof="BreadcrumbList">
            ...
            <li property="itemListElement" typeof="ListItem">
                ...
                <meta itemprop="name" content="Conveyor Pulleys">
                <meta itemprop="url" content="http://www.wencomining.com/product-details/conveyor-pulleys/">
                <span property="name"><?php echo ($cate_name); ?></span>
                <meta property="position" content="2"></li>
        </ol>
        </div><section class="page-title"><h1><?php echo ($cate_name); ?></h1></section></div></div>
    </div>
    ...
    <div  class="content_row default-style no-composer  fullwidth"><div class="content_row_wrapper clearfix "><div class="col col-sm-12 col-xs-12 ">
        ...
        <div class="tax-description clearfix ">
            ...
            <p>WENCO Mining supplies quality conveyor belts to its vast client base, by being a Tier 1 supplier who could have input into design and the subsequent manufacture. Besides supplying conveyor belts WENCO Mining can supply to satisfy any requirement a conveyor system may have by providing the market with custom belt lengths, vulcanizing equipment, belt clamps, idlers / rollers, pulley fabrication, lagging etc. WENCO Mining’s capability includes steel cord conveyor, vacuum filter belts and incline belts.</p>

        </div>
        <div class="rt_divider style-5"></div>


        <div id="product-dynamicID-910926" class="product_holder product-showcase clearfix  border_grid fixed_heights" data-column-width="3">
            <div class="row clearfix">
                <?php if(is_array($pro_list)): $i = 0; $__LIST__ = $pro_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 3 );++$i; if(($mod) == "0"): ?></div>
        </div>
        <div id="product-dynamicID-910926" class="product_holder product-showcase clearfix  border_grid fixed_heights" data-column-width="3">
            <div class="row clearfix"><?php endif; ?>
                <div class="col product_item_holder col-sm-4  conveyor-belts">
                    ...
                    <div class="product_item_holder">
                        ...
                        <div class="featured_image">
                            <!-- product image -->
                            <div class="featured_image">
                                <a href="/product/<?php echo ($p['url']); ?>.html" title="<?php echo ($p['product_name']); ?>" rel="bookmark" class="imgeffect link"><img src="<?php echo ($p['product_pic']); ?>" alt="<?php echo ($p['product_name']); ?>" class="" /></a>
                            </div>
                        </div>
                        ...
                        <div class="product_info">
                            ...
                            <!-- title-->
                            <h5 class="clean_heading"><a href="/product/<?php echo ($p['url']); ?>.html" title="<?php echo ($p['product_name']); ?>" rel="bookmark"><?php echo ($p['product_name']); ?></a></h5>

                            <!-- text-->

                            <div class="product_info_footer clearfix"><div class="action_buttons"><a href="/product/<?php echo ($p['url']); ?>.html" title="Conveyor Pulleys" class="details icon-angle-right">Details</a></div></div>
