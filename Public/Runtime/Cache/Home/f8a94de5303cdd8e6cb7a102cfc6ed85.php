    ...
    <header class="top-header fullwidth sticky">
        ...
        <div class="header-elements default">
            ...
            <div class="header-right">
                <nav class="main-navigation"><ul id="navigation" class="menu"><li id='menu-item-3148' data-depth='0' class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children"><a  href="/project/index.html"><span>PRODUCTS</span></a>
                    <ul class="sub-menu">
    ...
    <div class="content_row row sub_page_header fullwidth " style="background-image: url(http://www.wencomining.com/wp-content/uploads/2015/02/bridge.jpg);background-size: auto auto;background-position: right top;">
        ...
        <div class="content_row_wrapper  default" ><div class="col col-sm-12"><div class="breadcrumb"><ol vocab="http://schema.org/" typeof="BreadcrumbList">
            ...
            <li property="itemListElement" typeof="ListItem">
                ...
                <meta itemprop="name" content="News Center">
                <meta itemprop="url" content="/news-center.html">
        ...
        <div class="row fixed_heights">
            <div class="col col-sm-3 col-xs-12 sidebar left widgets_holder">
                <div id="latest_posts_2-2" class="widget widget_latest_posts"><h5>Recent Posts</h5>
                    <?php if(is_array($recent)): $i = 0; $__LIST__ = $recent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><div>
                        <img src="<?php echo ($c['pic_url']); ?>" alt="Chute Liners" class="post-thumb" />
                        <a class="title" href="/news/<?php echo ($c['url']); ?>.html" title="<?php echo ($c['title']); ?>" rel="bookmark"><?php echo ($c['title']); ?></a>
                        <span class="meta"><?php echo (date("F d,Y",$c['time'])); ?></span>
                    ...
                    <div class="content_row_wrapper  default" style="padding-top:0px;padding-left:0px;padding-right:0px;">
                        <div class="vc_col-sm-12 wpb_column vc_column_container" style="padding-right:25px;">
                            <div class="wpb_wrapper">
                                ...
                                <div id="blog-dynamicID-125134" class="blog_list clearfix " data-column-width="1">

                                    <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?><!-- blog box-->
                                    <article class="loop post-4636 post type-post status-publish format-standard has-post-thumbnail hentry category-mining-products tag-conveyor-belts tag-mining-equipment-suppliers tag-mining-equipments tag-mining-supplies tag-wear-protection" id="post-4636">
                                        ...
                                        <figure class="featured_image featured_media">
                                            ...
                                            <a id="lightbox-893729" class="featured_image" data-group="image_4349" title="" data-title="Mining Equipment Suppliers in Perth" data-sub-html="#lightbox-893729-description" data-thumbnail="<?php echo ($n['pic_url']); ?>" data-thumbTooltip="" data-scaleUp="" data-href="" data-width="" data-height="" data-flashHasPriority="" data-poster="" data-autoplay="" data-audiotitle="" data-html="" href="/news/<?php echo ($n['url']); ?>.html" ><img src="<?php echo ($n['pic_url']); ?>" alt="Chute Liners" class="" /></a>
                                            <div class="lighbox-description hidden" id="lightbox-893729-description">
                                        ...
                                        <div class="date"><?php echo (date("F d,Y",$n['time'])); ?></div>
                                        <div class="text entry-content">

                                            <!-- blog headline-->
                                            <h2 class="entry-title"><a href="/news/<?php echo ($n['url']); ?>.html" rel="bookmark"><?php echo ($n['title']); ?></a></h2>
                                            <?php echo ($n['contents']); ?>
                                            <!-- meta data -->
                                            <div class="post_data">

                                                <!-- user -->
                                                <span class="icon-user user margin-right20"><a href="" title="Posts by net_admin" rel="author">net_admin</a></span>

                                                <!-- categories -->
                                                <span class="icon-flow-cascade categories"><a href="" rel="category tag">Mining Products</a></span>


                                                <!-- comments -->
                                                <span class="icon-chat-empty comment_link"><a href="" title="0 Comment" class="comment_link">0 Comment</a></span>
